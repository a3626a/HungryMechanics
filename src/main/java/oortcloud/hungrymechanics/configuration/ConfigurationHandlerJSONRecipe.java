...
public class ConfigurationHandlerJSONRecipe {
	...
	protected void createDefaultConfigurationFile(File file) {
		...
		int index_hungrymechanics = path_config.indexOf(References.MODID);
		String path_hungrymechanics = path_config.substring(index_hungrymechanics);
		String resourceName = "/assets/" + path_hungrymechanics.replace("\\", "/");
